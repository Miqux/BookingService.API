...
{
    public class UpdatedCompanyWithAddressCommandValidator : AbstractValidator<UpdatedCompanyWithAddressCommand>
    {
        public UpdatedCompanyWithAddressCommandValidator()
        {
