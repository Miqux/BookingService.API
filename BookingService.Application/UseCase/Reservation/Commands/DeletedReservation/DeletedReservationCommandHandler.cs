...
{
    public class DeletedReservationCommandHandler : IRequestHandler<DeletedReservationCommand, BaseResponse>
    {
        private readonly IGoogleCalendaryRepository googleCalendaryRepository;
        private readonly IReservationRepository reservationRepository;
        private readonly IServiceRepository serviceRepository;

        public DeletedReservationCommandHandler(IGoogleCalendaryRepository googleCalendaryRepository,
        ...
        public async Task<BaseResponse> Handle(DeletedReservationCommand request, CancellationToken cancellationToken)
        {
            var validator = await new DeletedReservationCommandValidator().ValidateAsync(request, cancellationToken);
